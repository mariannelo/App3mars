...
$(document).ready(function() {
 ...
 var yourIcon = L.icon({
   iconUrl: 'marker-or.png',
    ...
    L.marker(new L.LatLng(63.428200, 10.401784), {icon: myIcon}).addTo(Norkart.map).bindPopup("<b>Gamle bybru</b> <p>Kjent bru</p> <img src= 'bybrua.png' style='height: 200px; width: 250px;'' </img>");
/**/

// geoJSON-fil, resturanter på Solsiden (må være en egen fil for å få til et lag)
var url = 'resturantPub.html';
     $.getJSON(url, function(data) {
         Norkart.punktliste = [];
// //vi har fått data tilbake fra AJAX-requesten
...
// //legger kartlaget til i LayerControl for å la brukeren slå av og på kartlaget.
         Norkart.map.LayerControl.addOverlay(Norkart.geojsonLag,"Resturanter/barer");
